...
from server.src.api import suggest as suggest_module
...
def test_suggest_returns_list(monkeypatch):
    ...
    monkeypatch.setattr(suggest_module, "_try_searxng_autocompleter", mock)
...
def test_suggest_empty_suggestions(monkeypatch):
    ...
    monkeypatch.setattr(suggest_module, "_try_searxng_autocompleter", mock_auto)
    monkeypatch.setattr(suggest_module, "_try_searxng_search_suggestions", mock_search)
    monkeypatch.setattr(suggest_module, "_try_engine_search_suggestions", mock_engine)
