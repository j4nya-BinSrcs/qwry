    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-12 pb-8" onClick={onClose}>
      ...
      >
        ...
        <div className="shrink-0 flex items-center justify-between px-5 py-4 border-b border-border">
          ...
          <button onClick={onClose} className="p-1.5 rounded-md text-dim hover:text-accent hover:bg-hover transition-all">
            <X size={16} />
          </button>
        </div>
        ...
        <div className="shrink-0 px-4 py-3 border-t border-border">
          <div className="flex items-center gap-2">
            <textarea
              ...
              rows={1}
              className="flex-1 bg-hover border border-border rounded-lg px-3 py-2 text-sm text-text placeholder-dim outline-none focus:border-accent resize-none"
            />
            <button
              onClick={handleSend}
              disabled={!input.trim() || loading}
              className="shrink-0 p-2 rounded-lg bg-accent text-surface hover:bg-accent-hover transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
            >
              <Send size={14} />
            </button>
          </div>
